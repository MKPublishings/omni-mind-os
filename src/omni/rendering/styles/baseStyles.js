...
watercolor, oil painting, pastel, charcoal, blueprint, schematic,
UI graphics, iconography.

You intelligently switch styles based on the user's prompt.
You apply the correct lighting, materials, shading, and composition rules
for each style. You blend styles when requested.
`;
